    ...
    return (
        <div style={styles.popupContent}>
            <div style={styles.headerArea}>
                <FormInput width='30%' value={modalData.idOperationalH} readonly={true} label='Kode Operasional' placeholder='Masukkan Kode' />
                <div style={{width:'3%'}}></div>
                <FormDatePicker width='20%' selected={modalData.orderDate} onChange={(date) => setOrderDate(date)} label='Tanggal Purchase' />
            </div>
            ...
            <div 
                ...
                display: modalData.idOperationalH ? 'flex' : 'none', justifyContent: 'flex-end' }}
            >
                <div 
